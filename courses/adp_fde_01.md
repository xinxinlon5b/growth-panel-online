# 腾讯云 ADP 前沿部署工程师（FDE）认证课程 · 第 1 章

> 来源：腾讯云学院 · 腾讯云 ADP 前沿部署工程师 (FDE) 认证课程
> 本册：第 1 章 AI 和 Agent 基础
...
认识 **AI**，第一步不是记住那些名词、学习相关操作，而是先理清**AI**相关名词的关系：人工智能、机器学习、深度学习、生成式 **AI** 到底是什么、有什么关系，**AI** 又是沿着怎样的时间线，一步步走到如今能够进行“创造”的。

**本节学习目标**

学完这一节，你将能够说清人工智能、机器学习、深度学习、生成式 AI 之间的关系，不再被这些名词困扰；能够说出 AI 会“认”、会“判断”、会“创造”的三个发展阶段。

![本节脉络](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-01_本节脉络.png)
...
![AI与机器学习层级关系](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-02_AI与机器学习层级关系.png)
...
![人工智能概念](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-03_人工智能概念.png)
...
![符号AI与机器学习](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-04_符号AI与机器学习.png)
...
![深度学习神经网络](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-05_深度学习神经网络.png)
...
![生成式AI](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-06_生成式AI.png)

### 1.1.2 AI的发展阶段

理解了空间上的包含关系，我们再来看时间上的发展阶段。**AI** 从诞生到今天，大致可以分成三个阶段，以“会认”为主的 **AI** → “会判断”的 **AI** 大规模落地 → “会创造”的 **AI** 真正爆发。

**（1）第一阶段（约 1950s–1990s）：以“会认”为主的 AI**
...
![Yann LeCun 官网 LeNet demo 页面，手写数字识别示例](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.1/1.1-07_LeNet手写数字识别.png)

这个阶段的 AI，可以用一句话概括它的本事：“给它一个东西，它告诉我们这是什么。”是猫还是狗、是数字几——它擅长“认”，但也仅此而已，它不会思考，更不会创造。尽管本事朴素，这一阶段却是后面一切的根基，机器证明了它能从数据里学到规律。

**（2）第二阶段（约 1990s–2016）：“会判断”的AI大规模落地**

会“认”之后，AI 的下一步是学会“判断和预测”——不只是识别眼前这个东西是什么，还能基于数据做出决策、给出预测。

这一阶段之所以能起来，背后有两个现实推手：一是**互联网普及**，企业手里第一次攒下了海量数据；二是**计算机算力不断变强，**数据多了、算力够了，“让机器从数据里学规律”这条路才真正跑得通。于是，机器学习的各种经典算法开始大放异彩——比如决策树、支持向量机、随机森林等等。它们不像早期专家系统那样靠人写死规则，而是自己从大量历史数据里总结出判断的依据。
...
- 除此之外，还有**银行的信用评分与风控反欺诈、广告的点击率预测、搜索引擎的结果排序**等，背后都是这一套判断与预测的能力。
...
这些，都属于生成式AI。短短几年间，AI 从一个只会“认”和“判断”的工具，变成了**人人都能用的能写、能画、能作曲、能编程的“创造者”**，几乎渗透进内容、编程、设计等各行各业。其中，大语言模型是生成式 AI 的一种，而且是最主流、最核心的一种。
...
### 1.2 大语言模型的进化之路：从“会接龙”到“会做事”

**大语言模型是生成式 AI 的一种，而且是最主流、最核心的一种。大语言模型本质上只会做文字接龙，但依靠 Prompt、记忆、RAG、工具、MCP 逐步补齐短板，它逐渐从只会做文字接龙的AI成长为能做事的AI。**

**本节学习目标**

学完这一节，你将能够用一句话讲清大语言模型的本质，并解释它为什么会“幻觉”；能够说清大语言模型如何依靠Prompt、记忆、RAG、Tool Use、MCP 完成从“会说”到“会做”的能力跃迁。

![大语言模型从会接龙到会做事的能力演进](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.2/1.2-01_LLM预测下一个Token.png)

### 1.2.1 Transformer：大语言模型的起点

说到大语言模型，首先就得提一提Transformer。上一节我们提到，Transformer是一个深度学习的架构，不是一个具体的产品。Transformer引入了一种叫“注意力机制”的设计，让模型既能一眼看全整句话、抓住词与词之间的关联，又能大规模并行计算，**为“把模型做得又大又强”扫清了障碍。**我们可以把“架构”理解成**一张建筑图纸**。图纸本身不能住人，但按照这张图纸，我们可以盖出千千万万栋不同的楼。Transformer 就是这样一张革命性的“图纸”，2017 年被提出后，此后几乎所有厉害的生成式 AI 模型，都是照着这张图纸盖出来的。GPT、BERT、混元、DeepSeek……这些名字听起来五花八门，但它们本质上都是基于 Transformer 这张“图纸”盖出来的不同的“楼”。**照着Transformer 这张图纸，盖出来的第一批、也是最重要的一类"楼"，就是大语言模型。**
...
![大语言模型预测下一个 Token 的过程](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.2/1.2-02_上下文丢失示例.png)
...
既然模型只会根据我们给的文字往下接，那么一个很自然的想法便产生了：我们能不能**在它正式接龙之前，先塞给它一段文字，把它应当知道的设定、背景、规则都预先告诉它？**我们完全可以在这段输入里“做文章”，用文字提前为它立好规矩。这正是提示词（Prompt）的核心思想。
...
![上下文丢失示例](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.2/1.2-03_Embedding语义坐标.png)
...
正因如此，人们提出各种解决这个问题的办法，统称**上下文工程（Context Engineering）**：想办法把应当让模型看到的所有背景信息，都恰当地组织好、再喂给它。前面讲的提示词（Prompt），其实就是上下文工程的一部分；而其中另一个关键部分，就是记忆（Memory）。

**记忆通常分成两种：**

- **短期记忆：**

指的是**本次会话里说过的话**，模型能够记住。但它的“短”就体现在，一旦我们换到一个新的对话框，之前的内容便不复存在，模型又会“失忆”般地从头开始。

- **长期记忆：**

指的是**跨越所有会话、绑定在我们这个账号上的信息**，而不只是当前对话框里的内容。比如它记住了“我们从事财务工作、偏好简洁的回答、所在公司叫某某”，那么无论哪天、开哪个新对话，它都能延续这些信息。模型正是借由这种方式，才显得“记得”我们是谁、之前聊过什么。可以看出，所谓长期记忆，本质上仍是把该记住的内容，在恰当的时候重新组织成文字、再喂回给模型。
...
![Embedding 把语义转换为向量坐标](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.2/1.2-04_MCP标准接口.png)
...
这样一来，AI 的回答就有了**准确、实时、可溯源**的依据，“幻觉"问题被大大缓解。**这就是为什么企业做 AI，第一步几乎都是搭知识库**——本质就是在为 RAG 准备“坐标点”。

#### 1.2.6 工具调用（**Tool Use**）：让 **AI** 能“动手做事”

有了Prompt、Memory和RAG，AI 已经会说、会记、会查了。但它依然**只会“说”，不会“做”。** 要突破这一点，就要让 AI 学会用工具。
...
前面提到，工具本质上就是一个个可供模型调用的函数。当工具越来越多，一个新的麻烦便浮现出来：这些工具**各说各的“方言”**。例如，有的要求我们用英语来问，有的要求中文，有的又规定了另一套完全不同的参数格式；又或者这个工具把地点字段叫作 city，那个工具叫 location，还有的干脆叫“地点”。如果没有统一的规矩，就会陷入一种极其低效的局面，**每一个工具，都要为全球成千上万家 AI 公司分别对接、各自维护一套不同的接口**；反过来，**每一家 AI 公司，也要为成千上万个工具逐一适配**。这是一种“多对多”的重复劳动，无论对工具方还是模型方，都是一场灾难。
...
![MCP 标准接口连接外部工具与 AI 应用](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.2/1.2-05_智能体基础导图.png)
...
学完这一节，你将理解智能体与普通大语言模型工具的区别；能说清 Goal–Action–Observation 循环如何让 Agent 运转；能区分单 Agent、多 Agent、Workflow、Claw 等典型编排方式；能理解企业为什么需要 ADP 这样的智能体开发平台。

![智能体从一问一答走向自主完成目标](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-01_普通AI工具与智能体.png)
...
![普通 AI 工具与智能体的关键差异](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-02_LLM与Agent关键差异.png)
...
![Agent 的 Goal Action Observation 循环](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-03_LLM接龙形成Agent循环.png)
...
![LLM 通过行动和观察持续完成任务](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-04_Agent四种编排方式.png)
...
![Agent 的四种典型编排方式](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-05_单Agent与多Agent.png)
...
![单 Agent 与多 Agent 的差异](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-06_多Agent角色卡.png)
...
![Workflow 将业务流程固化成流水线](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-08_Workflow节点配置.png)
...
【视频】https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/video/claw-demo-v2.mp4
...
下面用四个任务检验一下判断力：为每项任务选择最合适的执行策略。判断时要关注**权限、可逆性和外部影响**。

> **QUIZ** 1.3 · 判断 1/4
>
> 任务一：读取指定课程资料文件夹，并在新文件中生成内容摘要。 最合适的执行策略是？

- **A** 可自动执行
- **B** 需要人工确认
- **C** 不应执行

**答案** A：输入范围明确、结果写入新文件且可逆，可以在限定目录和权限下自动执行。

> **QUIZ** 1.3 · 判断 2/4
>
> 任务二：向全部客户发送一封活动通知邮件。 最合适的执行策略是？

- **A** 可自动执行
- **B** 需要人工确认
- **C** 不应执行

**答案** B：会对外发送信息并影响大量收件人，必须在发送前由人确认对象、内容和时间。

> **QUIZ** 1.3 · 判断 3/4
>
> 任务三：永久删除项目源文件夹以释放磁盘空间。 最合适的执行策略是？

- **A** 可自动执行
- **B** 需要人工确认
- **C** 不应执行

**答案** C：不可逆且可能造成重大数据损失，不应让智能体直接执行；应改为可恢复的归档或回收站流程。

> **QUIZ** 1.3 · 判断 4/4
>
> 任务四：查询已授权的内部数据，并生成一份不对外发布的分析草稿。 最合适的执行策略是？

- **A** 可自动执行
- **B** 需要人工确认
- **C** 不应执行

**答案** A：在权限、数据范围和输出位置受控的前提下，可自动生成草稿，最终结论仍应复核。
...
![本地 Claw 与云端 Claw 对比](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-11_企业落地Agent五堵墙.png)
...
![企业落地 Agent 面临的五类现实障碍](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/1.3/1.3-12_企业级Agent六大特性.png)
...
系统始终受人类掌控，可暂停、停止并设置权限边界。

**业务示例：**删除客户信息前必须等待人工审批。

**ADP：**权限边界、人工干预、发布审批、工具范围控制。
...
能够验证 Agent 是否按预期工作，并重现问题。

**业务示例：**上线前使用测试集验证准确率和流程完成率。

**ADP：**调试工具、评测数据集、对话日志、节点运行记录。
...
**业务示例：**回溯某次拒答参考了哪个规则、何时执行。

**ADP：**知识引用来源、操作留痕、接口调用和决策回溯。
...
**业务示例：**成功率下降时告警并定位失败任务类型。

**ADP：**用量监控、效果分析、版本管理、异常定位与回滚。
...
知识、工具、规则和模板可被多个 Agent 复用。

**业务示例：**一个政策知识库授权给多个业务助手。

**ADP：**知识库共享、工具复用、Prompt 与 Workflow 沉淀。
...
**业务示例：**接入 CRM、ERP、工单系统或数据库。

**ADP：**API、数据库、MCP 和企业系统连接能力。
