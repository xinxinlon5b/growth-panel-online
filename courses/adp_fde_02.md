# 腾讯云 ADP 前沿部署工程师（FDE）认证课程 · 第 2 章
...
![ADP企业级智能体开发平台概览](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.1/2.1-01_ADP企业级智能体开发平台概览.png)

**本节学习目标**

学完这一节，你应能说明 ADP 的产品定位；理解企业为什么不能只靠一个大模型；读懂 ADP 产品能力地图中“构建模式 × 核心能力组件 × AI Model”的关系；了解ADP的四大优势；初步判断哪些任务适合用 ADP 构建智能体。
...
| **业务负责人：** 关注业务价值、效率提升、成本降低和服务体验。 | **业务运营人员：** 关注重复问答、文档处理、流程办理能否被助手承接。 |
| --- | --- |
| **IT / 平台团队：** 关注权限控制、系统接入、版本管理和安全运维。 | **售前 / 交付团队：** 关注可复用方案的搭建效率。 |
...
![ADP智能体搭建页面。可以进行应用设置、知识管理、工作流管理、发布运营、工具设置等](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.1/2.1-02_Claw模式应用设置界面.png)

> **QUIZ** 2.1 · 多选
>
> 下面哪些说法更接近 ADP？这是多选题，选好后提交，看看你是否抓住了 ADP 的产品定位。
...
**答案** B、C、D。ADP 不是单一聊天入口，而是把模型、知识、工具、流程、治理、发布和运营组织起来的企业级智能体开发平台；“只是一个聊天机器人”的说法不正确。
...
![大模型到ADP能力补足](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.1/2.1-03_大模型到ADP能力补足.png)
...
| **标准模式｜稳定问答** 以单个智能体为核心，结合 Prompt、模型、知识库和工具，适合企业知识问答、产品 FAQ、客服问答等稳定场景。 | **单工作流模式｜流程执行** 以固定流程为核心，把任务拆成节点、变量、条件分支和工具调用，适合审批、通知、信息收集、报告生成等标准化任务。 |
| --- | --- |
| **Multi-Agent 模式｜多角色协作** 由多个 Agent 分工协作，适合复杂分析、方案生成、交叉复核、多步骤决策等需要协同处理的任务。 | **Claw 模式｜开放任务** 更适合文件、网页、表格、代码和开放式任务处理，像一个能够动手完成复杂任务的数字同事。 |
...
工具、API、数据库、MCP、Skills 与企业系统连接器
...
![ADP 能力地图：构建模式 × 核心能力组件 × AI Model 的灵活组合](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.1/2.1-04_ADP能力地图_构建模式能力组件AI模型.png)
...
| **Knowledge** 企业知识库、制度问答、产品 FAQ、员工助手。 | **CS** 智能客服、售前咨询、售后问答、质检分析。 | **Due Diligence** 财务分析、尽调分析、资料归纳、风险初筛。 |
| --- | --- | --- |
| **Operation** 合同审阅、流程办理、任务分派、自动通知。 | **HR** 简历筛选、候选人评审、员工自助问答。 | **Admin** 行政自助流程、材料生成、内部服务台。 |
...
在真实业务里，"对话效果好不好"不只取决于大模型本身，更取决于系统能不能**准确看懂企业文档、高效检索、给出可靠答案**。ADP 在这方面积累深厚：
...
![ADP应用设置基础能力概览](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-01_ADP应用设置基础能力概览.png)

**本节学习目标**

学完这一部分，能够知道如何给 Agent 一个“大脑”和任务边界；了解应用基础信息可以编辑什么；理解 ADP 模型设置中各类模型的作用；知道角色指令如何限定模型回复的角色、语种、语气和版本；理解应用级变量、工作流级变量的类型与隔离范围；理解长期记忆如何为应用提供个性化对话体验。
...
![应用开发新建应用入口](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-02_应用开发新建应用入口.png)

![“新建应用”界面](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-03_新建应用与模式选择.png)
...
![“应用设置”界面](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-04_编辑应用与模式切换.png)
...
![“应用设置”界面：Claw模式。Claw模式应用不支持模式切换](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-05_应用设置页面概览.png)
...
![模型设置功能入口](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-06_模型设置功能入口.png)

![模型选择与切换](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-07_模型参数配置.png)

![模型设置参数详情](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-08_模型设置参数详情.png)
...
![角色指令](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-09_角色指令AI一键优化.png)
...
![欢迎语](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-10_欢迎语配置.png)
...
![应用级变量](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-11_应用变量配置.png)
...
- 从**隔离范围**上看，**用户隔离 > Session 隔离**。灵活使用变量可以满足复杂业务场景需求。

### **2.2.6 长期记忆**

长期记忆功能是实现个性化对话体验的核心，它如同为应用赋予了 “大脑记忆” 的能力。通过持续识别并精准留存与终端用户相关的各类关键信息，包括**用户的基础画像**（年龄、性别等）以及**重要的记忆点**（如特定时间在特定地点做过的事情等），让应用在后续与用户的每一次互动中，都能快速调用这些信息，从而提供更贴合用户个性化需求的回应，极大地提升用户的使用体验。

**长期记忆的唯一性由两大核心要素共同决定，即终端用户**和**应用**。意味着每一个终端用户在不同的应用中，都会形成独立且唯一的长期记忆。这种独立性能够确保用户在不同应用场景下的信息不会相互混淆，保证了记忆的针对性和准确性。
...
长期记忆主要分为“**长期记忆总结**”和“**长期记忆召回**”两个步骤，运行流程如下：

- 新用户首次发起对话，系统会根据终端用户 ID 和应用 ID 创建一份唯一的长期记忆，存储在 **SYS.Memory **中。

- 在用户与系统多轮对话时，系统调用 “**长期记忆总结**” 模块，根据对话历史自动总结长期记忆内容。

- **长期记忆总结的时效性**：每一轮对话都会运行总结模块并尝试提取长期记忆，并更新 **SYS.Memory **内容。

- 在用户新的对话中，系统调用 “**长期记忆召回**” 模块，拿到用户的长期记忆内容，帮助大模型了解用户画像及重要记忆点，与用户个性化对话。

- 例如：长期记忆内容为“用户是一名素食主义者”，那么后续为用户推荐附近的餐厅时，则主要推荐素食餐厅。

- 循环上述 “**长期记忆总结**” 和 “**长期记忆召回**” 过程。

长期记忆运行流程图如下：

![长期记忆运行流程图](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2上/2.2上-12_长期记忆运行流程.png)
...
学习完本节后，你将能够： 理解知识库与 **RAG** 的关系：知道 **ADP** 知识库如何让智能体基于企业知识回答问题。 了解知识库的主要能力：掌握文档、问答、数据库、知识库设置和 Agentic **RAG** 分别解决什么问题。 理解知识处理流程：知道文档从上传到检索，会经历解析、切分、干预和优化等环节。 区分知识库与工具：知道知识库负责“查资料”，工具、连接器和 Skills 负责“办事情”。
...
在腾讯云智能体开发平台，**知识库**存储的数据称为**知识**，分为以下三种类型：
...
ADP 中主要有两个层级的知识库：一是**平台级知识库**，可以在相同主账号下被多个应用关联使用；二是**应用内的默认知识库（应用级知识库）**，服务于当前应用。**平台级知识库适合企业级公共资料**，例如产品手册、政策制度、售后规则、行业方案等；**默认知识库适合当前应用的专属资料**，例如某个客服机器人自己的服务口径。

**Tips：**

当应用评测进行时，无法对知识库内容进行更改，包括新增导入、删除和修改知识设置。

![知识库层级](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-01_知识库评测锁定提示.png)

### **平台级知识库的创建与引用**

#### **（1）新建知识库**

单击左侧菜单栏中的**知识库 **> **新建知识库**，填写知识库名称和知识库描述。

![新建平台级知识库](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-02_新建知识库.png)

#### **（2）修改知识库名称**

**修改知识库名称**：单击知识库左上角即可修改知识库名称。

![修改知识库名称](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-03_修改知识库名称.png)

#### **（3）删除知识库**

如需删除知识库，请确保当前知识库未被任何应用所引用；被应用引用的知识库需要先解除引用关系后删除。

![删除知识库](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-04_删除知识库.png)

#### **（4）在应用内添加知识库**

单击应用，前往**应用 > 知识管理 > 添加知识库**。添加后即成功引用所添加的平台级知识库；若取消勾选，则为取消引用该平台级知识库。调整知识库的引用关系后需要重新发布应用。

![在应用内添加知识库](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-05_应用内添加知识库.png)
...
进入知识库文档页后，选择**知识管理 > 文档**，进入文档管理界面。支持导入文档、下载文档、删除文档及文档分类。可以通过本地文档、网页文件、腾讯文档和腾讯云对象存储（COS）四种方式导入文档。

![导入文档](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-06_知识库文档管理与导入.png)
...
- 确保所爬取的网页**无登录授权验证**，即无需验证当前用户身份和授予用户系统访问权限就可访问网页。
...
（2）手动对比：支持客户通过单击**文档对比任务** > 单击**添加对比任务 **> 选择需要进行对比的文档 > 单击**开始对比**手动**添加文档对比任务**。从文档列表中选择2个文档（仅支持选择待发布和已发布状态的文档），保存后将生成1条文档对比任务。

### **2.2 中.1.4 问答**

问答类知识是以**“问题—答案”形式成对存在**的知识。在将相关文档导入腾讯云智能体开发平台后，系统会自动生成对应的问答对。与传统的单纯文档内容分析相比，问答对具有更高的针对性和结构化程度：它能够直接将用户可能提出的问题与准确答案建立对应关系，减少了模型在理解和生成过程中的歧义。
...
知识库问答应用支持**新建问答、批量/手动导入问答、校验问答、问答分类等操作**。录入问答之后，当客户输入问题时，会将客户问题和问答库中的问题进行检索匹配，相似度达到一定阈值后，会输出对应回答。
...
![新建问答](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2中/2.2中-07_知识库问答优化示例.png)
...
- 已创建 **Claw 模式**或 **Multi-Agent 模式**应用（需要添加 AgenticRAGSearch 工具）。
...
理解 Workflow、Multi-Agent 与 Claw 分别适合解决什么问题；知道 Workflow 如何通过节点和变量保证流程稳定可控；知道 Multi-Agent 如何让模型自主规划、调用工具和多 Agent 协同；知道 Claw 如何通过独立工作空间、Skills、工具和连接器处理复杂自主任务。

![任务执行与编排能力进阶](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2下/2.2下-01_任务执行与编排能力进阶.png)
...
![工作流画布](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2下/2.2下-02_Workflow画布与节点连线.png)
...
工作流还**内置 Agent 全局监控节点跳转**，无需区分“对话流”和“工作流”，既能灵活对话又能确保精准执行流程。内置 Agent 负责接管对话、控制节点跳转、识别全局意图，例如识别“不继续执行工作流”等退出意图，以及“好的”“没问题”等寒暄意图，并智能回复。
...
![Multi-Agent 应用编设置页，可以添加Agent、配置转交关系和协同方式、添加工具和连接器等](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2下/2.2下-03_MultiAgent自主规划与协同.png)
...
![Multi-Agent核心工作流程](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.2下/2.2下-04_MultiAgent执行循环.png)
...
目前 Plan-and-Execute 模式仅支持**单轮对话**，即每次输入（query）都会独立处理，暂不支持基于历史上下文的多轮对话。
...
![ADP应用完整使用流程](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.3/2.3-01_ADP应用完整使用流程.png)
...
![权限体系](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.3/2.3-02_产品开通与工作空间创建.png)
...
模式选择决定后续搭建方式。标准模式更适合快速开始，单工作流模式更适合固定流程，Multi-Agent 模式更适合复杂任务中的分工协作，Claw 模式则更适合需要独立工作空间和自主处理能力的任务。请注意，**标准模式、单工作流模式、Multi-Agent 模式**三者之间，支持根据应用落地场景的需要进行模式切换：点击**头像**或者**模式** tag，即可在**编辑应用**中进行应用模式的切换；claw模式下不支持切换到其他模式。

![应用模式切换](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.3/2.3-03_应用模式选择.png)

模式切换时，应用下知识库和工作流范围保持不变，但不同模式之间应用配置项，如提示词、模型配置等在模式切换时不会相互继承，在切换模式时的配置更新原则的示意图如下：

![应用模式切换的配置更新示意图](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.3/2.3-04_应用模式切换配置.png)
...
![知识库连接器与工具配置](https://academy-pub-1255893580.cos.ap-guangzhou.myqcloud.com/html-course/static/cn/adp-agent/20260903-205605/images/2.3/2.3-05_知识库连接器与工具配置.png)
